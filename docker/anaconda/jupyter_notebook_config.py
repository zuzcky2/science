...
c.NotebookApp.default_kernel = 'science'
...
c.NotebookApp.notebook_dir = '/var/workspace/python'
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$JBNiHzg7Vl45SEYZ+SfoAw$FfmsUiw/esYwQgjVAAs+eUOizm6seLJUySlXuUZ6IPU'
